<template>
    <Box>
        <template #header>Offer #{{ offer.id }} <span v-if="offer.accepted_at" class="dark:bg-green-900 dark:text-gray-200 bg-green-200 text-green-900 p-1 rounded-md uppercase ml-1">Accepted</span></template>
